...
class ARARUI(ctk.CTkToplevel):
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.title("InvoiceMate Version 1.0: Accounts Receivable Aging Report (ARAR) Generator")
    ...
    def make_user_interface(self):
        ...
        self.add_invoice_button = CTkButton(self.user_interface_frame, text="Add Invoice", fg_color="#343638", border_color="#565b5e", command=self.add_invoice)
        ...
        self.delete_invoice_button = CTkButton(self.user_interface_frame, text="Delete Invoice", fg_color="#343638", border_color="#565b5e", command=self.delete_invoice)
        ...
        self.view_invoices_button = CTkButton(self.user_interface_frame, text="View AR Aging Report", command=lambda: os.system("start excel.exe ARAR.xlsx"), fg_color="#343638", border_color="#565b5e")
